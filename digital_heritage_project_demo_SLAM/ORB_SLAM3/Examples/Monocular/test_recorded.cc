...
int main(int argc, char **argv)
{
    ...
    if (bFileName)
    {
        const string kf_file = KF_Trajectory_pathSaveFileName + "kf_" + string(argv[argc - 1]) + ".euroc";
        const string f_file = C_Trajectory_pathSaveFileName + "f_" + string(argv[argc - 1]) + ".euroc";
